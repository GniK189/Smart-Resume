    ...
    <>
      <div className="min-h-[70vh]">
        ...
        <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
          ...
          {/* Testimonial */}
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto m-12">
            {/* Testimonial 1 */}
            <div className="w-full max-w-88 space-y-4 rounded-md border border-gray-200 bg-white p-3 text-gray-500 transition-all duration-300 hover:-translate-y-1">
              ...
              <p>
                “Super clean and easy to use. This help me save a lot of time!”
              </p>
            ...
            <div className="w-full max-w-88 space-y-4 rounded-md border border-gray-200 bg-white p-3 text-gray-500 transition-all duration-300 hover:-translate-y-1">
              ...
              <p>
                “Highly recommend for who wanna create CV/Resume but don't have
                much experience!”
              </p>
              <div className="flex items-center gap-2 pt-3">
                <img
