...
const Footer = () => {
  return (
    <div id="about">
      <footer className="flex flex-col items-center justify-center w-full py-10 bg-gradient-to-b from-[hsl(231,39%,49%)] to-[#998da3] text-white/70">
        <img src="/logo.svg" alt="Logo" />
        <p className="mt-4 text-center">Made by Nguyen Phan Trung Hieu</p>
        <div className="flex items-center gap-4 mt-5">
          <a
            href="https://www.facebook.com/nguyen.phan.trung.hieu.164361"
          ...
          <a
            href="https://www.instagram.com/_gnikhere/"
            className="hover:-translate-y-0.5 transition-all duration-300"
          >
            <svg
              width="24"
          ...
          <a
            href="https://www.linkedin.com/in/nptrunghieu/"
            className="hover:-translate-y-0.5 transition-all duration-300"
          >
            <svg
              width="24"
